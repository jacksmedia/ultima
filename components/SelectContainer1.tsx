...
const SelectContainer1: React.FC = () => {
  ...
  useEffect(() => {
    const fetchFolders = async () => {
      try {
        const subfoldersResponse = await fetch('./patches/battle-patches.json'); // Access JSON file with subfolder data
  ...
  return (
    <div>
      <PreviewContainer selectedValue={selectedValue} style={{ paddingTop: '95px' }} />
...
export default SelectContainer1;