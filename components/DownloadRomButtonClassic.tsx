// DownloadRomButtonClassic.tsx authored by Claude Sonnet 4 - REFACTORED
import React, { useState } from 'react';

interface DownloadRomButtonClassicProps {
  onGenerateRom: () => Promise<Uint8Array>; // NEW: Function to generate patched ROM
  filename: string;
  disabled?: boolean;
}

const DownloadRomButtonClassic: React.FC<DownloadRomButtonClassicProps> = ({ 
  onGenerateRom, 
  filename, 
  disabled = false 
}) => {
...
export default DownloadRomButtonClassic;