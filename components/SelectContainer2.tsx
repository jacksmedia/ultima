...
const SelectContainer2: React.FC = () => {
  ...
  useEffect(() => {
    const fetchFolders = async () => {
      try {
        const subfoldersResponse = await fetch('./patches/map-patches.json'); // Access JSON file with subfolder data
  ...
  return (
    <div>
      <PreviewContainer selectedValue={selectedValue} style={{ paddingTop: '15px' }}/>
